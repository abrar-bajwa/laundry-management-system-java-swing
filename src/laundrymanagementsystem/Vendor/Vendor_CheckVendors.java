 ...
 * @author Bajwa
 */
public class Vendor_CheckVendors extends javax.swing.JFrame {

    /**
     * Creates new form Vendor_CheckVendors
     */
    public Vendor_CheckVendors() {
        initComponents();
        scaleImage();
...
// Load the third image file as a resource from the classpath
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Gulshan-e-Iqbal");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        dispose();
        Vendor_Reviews vend_reviews = new Vendor_Reviews();
        vend_reviews.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        dispose();
        Vendor_EditVendors vend_Edit = new Vendor_EditVendors();
        vend_Edit.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vendor_CheckVendors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vendor_CheckVendors().setVisible(true);
            }
        });
    }
