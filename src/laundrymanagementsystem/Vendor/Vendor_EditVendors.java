 ...
 * @author Bajwa
 */
public class Vendor_EditVendors extends javax.swing.JFrame {

    /**
     * Creates new form Vendor_EditVendors
     */
    public Vendor_EditVendors() {
        initComponents();
        scaleImage();
...
// Load the third image file as a resource from the classpath
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vendor_EditVendors.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vendor_EditVendors().setVisible(true);
            }
        });
    }
