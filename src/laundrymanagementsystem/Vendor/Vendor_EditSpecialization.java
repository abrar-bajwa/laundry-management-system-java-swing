 ...
 * @author Bajwa
 */
public class Vendor_EditSpecialization extends javax.swing.JFrame {

    /**
     * Creates new form Vendor_EditSpecialization
     */
    public Vendor_EditSpecialization() {
        initComponents();
        scaleImage();
...
// Load the third image file as a resource from the classpath
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Edit Specialization");
        ...
        jLabel13.setText("Edit Specialization");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vendor_EditSpecialization.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vendor_EditSpecialization().setVisible(true);
            }
        });
    }
