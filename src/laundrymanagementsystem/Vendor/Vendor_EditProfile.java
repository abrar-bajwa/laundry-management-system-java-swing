 ...
 * @author Bajwa
 */
public class Vendor_EditProfile extends javax.swing.JFrame {

    /**
     * Creates new form Vendor_EditProfile
     */
    public Vendor_EditProfile() {
        initComponents();
        scaleImage();
...
// Load the third image file as a resource from the classpath
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vendor_EditProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vendor_EditProfile().setVisible(true);
            }
        });
    }
