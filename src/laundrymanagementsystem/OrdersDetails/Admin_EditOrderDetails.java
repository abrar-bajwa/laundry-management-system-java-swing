 ...
 * @author Bajwa
 */
public class Admin_EditOrderDetails extends javax.swing.JFrame {

    /**
     * Creates new form Admin_EditOrderDetails
     */
    public Admin_EditOrderDetails() {
        initComponents();
...
// Load the third image file as a resource from the classpath
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 160, 120, 30));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 190, 120, 30));
        ...
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 190, 180, 30));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel7.setText("Order Date");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 220, 120, 30));
        jPanel2.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 220, 180, 30));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setText("Total Cost");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 250, 120, 30));
        jPanel2.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 250, 180, 30));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel9.setText("Payment Status");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 280, 120, 30));
        jPanel2.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 280, 180, 30));
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 310, 120, 30));
        ...
        jPanel2.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 310, 180, 30));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel10.setText("Order Id");
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 130, 120, 30));
        ...
        jPanel2.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 130, 180, 30));
        ...
        jLabel13.setText("Edit Orders Details");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_EditOrderDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_EditOrderDetails().setVisible(true);
            }
        });
    }
